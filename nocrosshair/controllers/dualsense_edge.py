...
_DUAL_SENSE_EDGE_DESCRIPTOR = ControllerDescriptor(
    ...
    extra_button_count=4,
    battery_capacity_mah=1560,
    weight_g=325.0,
    dimensions_mm=(162.0, 104.0, 52.0),
    vid_pid=(0x054C, 0x0DF2),
    uinput_name="Sony DualSense Edge Wireless Controller",
    uinput_vendor=0x054C,
    uinput_product=0x0DF2,
...
class DualSenseEdge(ControllerHardware):

    def __init__(self) -> None:
        super().__init__(_DUAL_SENSE_EDGE_DESCRIPTOR)
